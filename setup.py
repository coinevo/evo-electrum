...
setup(
    ...
    description="Lightweight Coinevo Wallet",
    author="CodeFace",
    author_email="codeface@coinevo.tech",
    license="MIT Licence",
    url="https://coinevo.tech",
    long_description="""Lightweight EVO Wallet""",
)
