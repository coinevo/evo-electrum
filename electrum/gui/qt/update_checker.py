...
class UpdateCheck(QDialog, Logger):
    url = "https://api.github.com/repos/coinevo/evo-electrum/releases/latest"
    download_url = "https://github.com/coinevo/evo-electrum/releases/latest"

    def __init__(self, *, latest_version=None):
        QDialog.__init__(self)
        self.setWindowTitle('Coinevo Electrum - ' + _('Update Check'))
